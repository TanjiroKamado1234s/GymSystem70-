 ...
 * @author AJ
 */
public class UserSubscription extends javax.swing.JFrame {
    ...
    public void displayData(){
        try{
            ...
            usubTable.setModel(DbUtils.resultSetToTableModel(rs));
             rs.close();
    ...
    private void initComponents() {
        ...
        usubTable = new javax.swing.JTable();
        ...
        jPanel2.add(acc_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, 120, 30));
        ...
        jPanel2.add(acc_lname, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 120, 30));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 80, -1));
        ...
        jPanel2.add(view, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 80, -1));

        jButton3.setText("jButton1");
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 310, 80, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ICONS/fitness (2).png"))); // NOI18N
        ...
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 0, 370, 40));
        ...
        usubTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                usubTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(usubTable);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(180, 50, 640, 490);
    ...
    private void viewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_viewMouseClicked
         int rowIndex = usubTable.getSelectedRow();
        ...
        if(rowIndex < 0){
            ...
            try{
                DbConnector dbc = new DbConnector();
                TableModel tbl = usubTable.getModel();
                ResultSet rs = dbc.getData("SELECT * FROM tbl_sub WHERE s_id = '"+tbl.getValueAt(rowIndex, 0)+"'");
                if(rs.next()){
                 ViewYourSubscription vys = new ViewYourSubscription();
                
                 vys.sid.setText(""+rs.getString("s_id"));
                 vys.sfname.setText(""+rs.getString("s_fname"));
                 vys.slname.setText(""+rs.getString("s_lname"));
                 vys.sdate.setText(""+rs.getString("s_sdate"));
                 vys.edate.setText(""+rs.getString("s_edate")); 
                 vys.sstatus.setText(""+rs.getString("s_status"));
                 
                 vys.image.setIcon(vys.ResizeImage(rs.getString("s_image"),null,vys.image));
                 vys.setVisible(true);
                 this.dispose();
            }
            }catch(SQLException ex){
    ...
    private void usubTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_usubTableMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_usubTableMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserSubscription.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserSubscription().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable usubTable;
